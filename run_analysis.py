...
if __name__=="__main__":
    ...
    if arg == 1:
        ...
        stackplot(firsttwelve,14,Nvmax,figfilename='stackLX14_normNvmax_s1.png',lw=2,color='k',alpha=.2,normtohost=True)
    if arg == 2:
        SHMF       = SHMFPlugin()
    ...
    if arg == 3:
        ...
        stackplot(firsttwelve,14,VelProfile,figfilename='stackLX14_normvelprof_s1.png',color='k',alpha=.2,normtohost=True)
    if arg == 4:
        ...
        stackplot(firsttwelve,14,MassAccr,figfilename='stackLX14_massaccr_s1.png',lw=2,color='k',alpha=.2)
        stackplot(firsttwelve,14,MassAccr,figfilename='stackLX14_normmassaccr_s1.png',lw=2,color='k',alpha=.2,normtohost=True)
        ...
        stackplot(firsttwelve,14,LinMassAccr,figfilename='stackLX14_linmassaccr_s1.png',lw=2,color='k',alpha=.2)
        stackplot(firsttwelve,14,LinMassAccr,figfilename='stackLX14_normlinmassaccr_s1.png',lw=2,color='k',alpha=.2,normtohost=True)
    if arg == 5:
